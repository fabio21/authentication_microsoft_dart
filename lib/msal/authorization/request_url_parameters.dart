...
class AuthorizationRequestUrlParameters {
   ...
   String correlationId;
    ...
    Map<String, List<String>> requestParameters  = new Map();

     static Builder builder({String redirectUri, Set<String> scopes}) {
         if(redirectUri != null && scopes != null) return Builder().;
   ...
   AuthorizationRequestUrlParameters(Builder builder){
        //required parameters
    ...
    URL createAuthorizationURL(Authority authority,
     ...
     static class Builder {
       ...
       String redirectUri;
       Set<String> scopes;
       Set<String> extraScopesToConsent;
       Set<String> claims;
