...
import 'package:microsoft_authentication/msal/authorization/request_url_parameters.dart';

///
 ///Interface representing an application for which tokens can be acquired.
///
abstract class IClientApplicationBase {
...
//     java.util.function.Consumer<java.util.List<java.util.HashMap<String, String>>> telemetryConsumer();
    ...
    ///
    Future<IAuthenticationResult> acquireToken(AuthorizationCodeParameters parameters);
    ...
    ///
     ...
     ///@return A {@link CompletableFuture} object representing the {@link IAuthenticationResult} of the call.
    ///
    Future<IAuthenticationResult> acquireToken(RefreshTokenParameters parameters);
